...
exports.LocalDevDataProvider = void 0;
const node_json_db_1 = require("node-json-db");
const JsonDBConfig_1 = require("node-json-db/dist/lib/JsonDBConfig");
class LocalDevDataProvider {
    constructor(url) {
        ...
        this.db = new node_json_db_1.JsonDB(new JsonDBConfig_1.Config(dbPath, true, false, this.SEPARATOR));
    }
...
exports.LocalDevDataProvider = LocalDevDataProvider;
