...
const pusher_utils_1 = require("./pusher-utils");
const utils_1 = require("./utils");
const _WEBCHAT_PUSHER_KEY_ = (0, utils_1.getWebpackEnvVar)(
// @ts-ignore
typeof WEBCHAT_PUSHER_KEY !== 'undefined' && WEBCHAT_PUSHER_KEY, 'WEBCHAT_PUSHER_KEY', '434ca667c8e6cb3f641c' // pragma: allowlist secret
);
...
class HubtypeService {
    ...
    _initPusher() {
        ...
        this.pusher = new pusher_js_1.default(_WEBCHAT_PUSHER_KEY_, Object.assign({ cluster: 'eu', authEndpoint: `${_HUBTYPE_API_URL_}/v1/provider_accounts/webhooks/webchat/${this.appId}/auth/`, forceTLS: true, auth: {
        ...
        const connectionPromise = new Promise((resolve, reject) => {
            ...
            this.channel.bind('botonic_response_compressed', compressedData => {
                try {
                    const data = JSON.parse((0, pusher_utils_1.decompressData)(compressedData));
    ...
    async postMessage(user, message) {
        try {
            ...
            await axios_1.default.post(`${_HUBTYPE_API_URL_}/v1/provider_accounts/webhooks/webchat/${this.appId}/`, {
                sender: this.user,
                message: message,
            }, {
    ...
    static async getWebchatVisibility({ appId, }) {
        return axios_1.default.get(`${_HUBTYPE_API_URL_}/v1/provider_accounts/${appId}/visibility/`);
    }
    destroyPusher() {
        if (!this.pusher)
            return;
