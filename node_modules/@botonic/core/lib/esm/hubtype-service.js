...
export class HubtypeService {
    ...
    _initPusher() {
        ...
        this.pusher = new Pusher(_WEBCHAT_PUSHER_KEY_, Object.assign({ cluster: 'eu', authEndpoint: `${_HUBTYPE_API_URL_}/v1/provider_accounts/webhooks/webchat/${this.appId}/auth/`, forceTLS: true, auth: {
    ...
    async postMessage(user, message) {
        try {
            ...
            await axios.post(`${_HUBTYPE_API_URL_}/v1/provider_accounts/webhooks/webchat/${this.appId}/`, {
                sender: this.user,
                message: message,
            }, {
    ...
    static async getWebchatVisibility({ appId, }) {
        return axios.get(`${_HUBTYPE_API_URL_}/v1/provider_accounts/${appId}/visibility/`);
    }
    destroyPusher() {
        if (!this.pusher)
            return;
